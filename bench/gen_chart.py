...
data = [
    ...
    # Irmini + all optimizations (inodes + cache + inlining + resolved, 30-byte values)
    ("Irmini+all (memory)",    "commits",      271521),
    ("Irmini+all (memory)",    "reads",        253347),
    ("Irmini+all (memory)",    "incremental",  14518),
    ("Irmini+all (memory)",    "large-values", 17866),
    ("Irmini+all (lavyek)",    "commits",      231184),
    ("Irmini+all (lavyek)",    "reads",        251674),
    ("Irmini+all (lavyek)",    "incremental",  8652),
    ("Irmini+all (lavyek)",    "large-values", 10279),
    ("Irmini+all (lavyek)",    "concurrent",   704179),
